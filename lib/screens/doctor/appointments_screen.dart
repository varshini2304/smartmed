...
class _DoctorAppointmentsScreenState extends State<DoctorAppointmentsScreen> {
  ...
  final List<Appointment> appointments = [
    ...
    Appointment(
      ...
      dateTime: DateTime.now().add(const Duration(days: 1)).copyWith(hour: 9, minute: 0),
      status: AppointmentStatus.scheduled,
      isUrgent: true,
  ...
  List<Appointment> get filteredAppointments {
    return appointments.where((appointment) {
      final matchesDate = appointment.dateTime.day == selectedDate.day &&
          appointment.dateTime.month == selectedDate.month &&
          appointment.dateTime.year == selectedDate.year;
      final matchesStatus = filterStatus == null || appointment.status == filterStatus;
      final matchesSearch = searchQuery.isEmpty ||
          appointment.patientName.toLowerCase().contains(searchQuery.toLowerCase()) ||
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    ...
                    subtitle: Text('${_formatTime(appointment.dateTime)} • ${_getStatusText(appointment.status)}'),
