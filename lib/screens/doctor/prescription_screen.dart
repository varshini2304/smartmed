...
class _CreatePrescriptionScreenState extends State<CreatePrescriptionScreen> {
  ...
  void _submitPrescription() {
    if (_formKey.currentState!.validate()) {
      ...
      bool hasValidMedicine = prescriptionItems.any(
        (item) =>
      ...
      if (!hasValidMedicine) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text(
              'Please add at least one medicine with complete details',
            ),
            backgroundColor: Colors.red,
          ),
        );
        ...
        builder: (context) => AlertDialog(
          ...
          content: Column(
            ...
            children: [
              ...
              Text(
                'Medicines: ${prescriptionItems.where((item) => item.medicineName.isNotEmpty).length}',
              ),
              const SizedBox(height: 10),
              const Text(
                'The prescription has been saved and can be printed or sent electronically.',
              ),
            ],
          ),
          actions: [
                            ...
                            (item) => Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Text(
                                    '  ${item.beforeMeal ? "Before meals" : "After meals"}',
                                  ),
                                ],
                              ),
                            ),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        elevation: 3, // Matches the original boxShadow effect
      ),
      body: Container(
        decoration: BoxDecoration(
                  ...
                  Container(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        // TextFormField for Primary Diagnosis
                        TextFormField(
                            ...
                            child: Column(
                              children: [
                                ...
                                DropdownButtonFormField<String>(
                                  value: item.medicineName.isEmpty
                                      ? null
                                      : item.medicineName,
                                  decoration: InputDecoration(
                                        ...
                                        (medicine) => DropdownMenuItem(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                '${medicine.strength} ${medicine.type} - ${medicine.category}',
                                                style: TextStyle(
                                                  fontSize: 12,
                                                  color: Colors.grey[600],
                                                ),
